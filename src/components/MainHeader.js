                ...
                <ul className="items">
                  ...
                  <li>
                    <a href="/bbs/project-view.php?idx=48">
                      ...
                      <div className="tit">성남 내정초등학교 다목적체육관</div>
                    </a>
                  </li>
                  <li>
                  ...
                  <li>
                    <a href="/bbs/project-view.php?idx=49">
                      ...
                      <div className="tit">성남 하탑초등학교 다목적체육관</div>
                    </a>
                  </li>
                  <li>
                  ...
                  <li>
                    <a href="/bbs/project-view.php?idx=77">
                      ...
                      <div className="tit">창원 합성초등학교 다목적강당</div>
                    </a>
                  </li>
                  <li>
                  ...
                  <li>
                    <a href="/bbs/project-view.php?idx=117">
                      ...
                      <div className="tit">사당4동 도시재생현장지원센터</div>
                    </a>
                  </li>
                  <li>
                  ...
                  <li>
                    <a href="/bbs/project-view.php?idx=118">
                      ...
                      <div className="tit">한탄강국가지질공원 방문자센터</div>
                    </a>
                  </li>
                  <li>
                  ...
                  <li>
                    <a href="/bbs/project-view.php?idx=127">
                      ...
                      <div className="tit">전주 출입국관리소 군산 출장소</div>
                    </a>
                  </li>
                  <li>
                  ...
                  <li>
                    <a href="/bbs/project-view.php?idx=146">
                      ...
                      <div className="tit">인천광역시 미추홀구 보훈회관</div>
                    </a>
                  </li>
                  <li>
                  ...
                  <li>
                    <a href="/bbs/project-view.php?idx=206">
                      ...
                      <div className="tit">서울대학교 실험동물자원관리동</div>
                    </a>
                  </li>
                  <li>
                  ...
                  <li>
                    <a href="/bbs/project-view.php?idx=214">
                      ...
                      <div className="tit">한국방송통신대학교 전북지역대학</div>
                    </a>
                  </li>
                  <li>
                  ...
                  <li>
                    <a href="/bbs/project-view.php?idx=216">
                      ...
                      <div className="tit">진주 경상국립대학교 가좌캠퍼스</div>
                    </a>
                  </li>
                  <li>
                  ...
                  <li>
                    <a href="/bbs/project-view.php?idx=241">
                      ...
                      <div className="tit">화성시 동탄 호수공원 어울림센터</div>
                    </a>
                  </li>
                  <li>
                  ...
                  <li>
                    <a href="/bbs/project-view.php?idx=274">
                      ...
                      <div className="tit">서울 도신초 병설유치원 승강기</div>
                    </a>
                  </li>
                  <li>
                    <a href="/bbs/project-view.php?idx=284">
                      ...
                      <div className="tit">목사랑시장 고객주차장&공유센터</div>
                    </a>
                  </li>
                  <li>
                  ...
                  <li>
                    <a href="/bbs/project-view.php?idx=289">
                      ...
                      <div className="tit">경인교대 경기캠퍼스 예림생활관</div>
                    </a>
                  </li>
                  <li>
